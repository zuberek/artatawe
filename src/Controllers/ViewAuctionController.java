...
public class ViewAuctionController {
	...
	public void submitBid() {
		float bid;
>>>>>>> 1a675332423d6251d7f0ca7ed8a1892066417000
...
public class ViewAuctionController {
	...
	/**
	 * Set the auction that is being edited.
	 * When this window is closed, the changes will be set in this auction object.
	 * @param currentUser user to change and initialise
	 * @param auction auction to be altered
	 */
	public void initialize(User currentUser, Auction auction) {
		this.currentUser = currentUser;
		this.auction = auction;
